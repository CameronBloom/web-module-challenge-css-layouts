...
- [x] Make an initial push after you complete your HTML structure, then make a Pull Request onto the main branch of *YOUR* repository (not BloomTech's).
      ==> [x] Run `git push --set-upstream origin firstName-lastName-responsive`
      ==> [x] In GitHub, use "active branches" and "new pull request".
      ==> [x] Set "base:" repository to the primary repository.
      ==> [x] Set "compare:" repository to the local branch `firstName-lastName-responsive` and click "create pull request".
      ==> [x] Review the pull request and merge the branch commits.
- [x] Go into Canvas and connect your repository by copy-pasting its Pull Request URL into the submission slot.
...
- [x] Complete your work making regular commits to the `firstName-lastName-responsive` branch; your submitted URL will always reflect your most recent work.
